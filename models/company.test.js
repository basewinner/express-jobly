...
describe("findAll", function () {
  ...
  //test to filter by minimum employees
  ...
  //test to filter by max employees
  ...
  //test to filter by min and max employees
  ...
  //this tests to find by name and also the ILIKE functionality
